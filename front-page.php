...
<main class="flex-1">
    <section class="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-b from-primary/5 via-primary/10 to-transparent" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/arabic-pattern.svg'); background-position: center;">
