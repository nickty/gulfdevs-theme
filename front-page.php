            ...
            <div class="flex flex-col items-center space-y-4 text-center">
                <div class="space-y-2">
                    <h1 class="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                        <?php echo esc_html(get_theme_mod('hero_title', __('Innovative Web Solutions for the Gulf', 'gulfdevs'))); ?>
                    </h1>
                    <p class="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                        <?php echo esc_html(get_theme_mod('hero_subtitle', __('Empowering businesses with cutting-edge technology', 'gulfdevs'))); ?>
                    </p>
                </div>
                <div class="space-x-4">
    ...
    <section id="services" class="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
        <div class="container px-4 md:px-6 mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <?php
                $services = array(
                    array('title' => __('Custom Web Development', 'gulfdevs'), 'description' => __('Tailored websites built with cutting-edge technology', 'gulfdevs')),
                    array('title' => __('E-commerce Solutions', 'gulfdevs'), 'description' => __('Secure and scalable online stores', 'gulfdevs')),
                    array('title' => __('UI/UX Design', 'gulfdevs'), 'description' => __('Beautiful, user-friendly interfaces', 'gulfdevs')),
                    array('title' => __('Database Solutions', 'gulfdevs'), 'description' => __('Robust data management systems', 'gulfdevs'))
                );

                foreach ($services as $service) :
                ?>
                    <div class="flex flex-col items-center text-center p-4 bg-white rounded-lg shadow-md dark:bg-gray-900">
                        <h3 class="text-xl font-bold mb-2"><?php echo esc_html($service['title']); ?></h3>
                        <p class="text-gray-500 dark:text-gray-400"><?php echo esc_html($service['description']); ?></p>
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <section class="w-full py-12 md:py-24 lg:py-32 bg-primary text-white">
        <div class="container px-4 md:px-6 mx-auto text-center">
            <blockquote class="text-2xl italic mb-4">
                <?php echo esc_html(get_theme_mod('testimonial_quote', __('GulfDevs transformed our online presence. Their understanding of local markets is unparalleled.', 'gulfdevs'))); ?>
            </blockquote>
            <p class="text-lg">
                - <?php echo esc_html(get_theme_mod('testimonial_author', __('Ahmed Al-Mansour, CEO of Gulf Innovations', 'gulfdevs'))); ?>
            </p>
        </div>
    </section>
</main>
